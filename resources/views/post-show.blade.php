...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex flex-wrap items-center gap-3 mb-6">
        <a href="{{ route('home') }}"
            class="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl border border-neutral-200 text-sm font-semibold text-neutral-700 hover:text-indigo-700 hover:border-indigo-300 transition-colors">
    ...
    <x-post-card :post="$post" :show-full-comments="true" />
</div>
@endsection
