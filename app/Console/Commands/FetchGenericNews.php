...
class FetchGenericNews extends Command
{
    ...
    public function __construct(protected PromptService $promptService)
    {
        parent::__construct();
    }
    ...
    private function fetchNewsWithAI(): ?array
    {
        ...
        AiLog::create([
            ...
            'status_code' => 200,
            'error_message' => null,
            'prompt_file' => 'fetch_generic_news.md',
        ]);
    ...
    {
        return $this->promptService->read('fetch_generic_news.md');
    }
}
