...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-3xl p-8 sm:p-12 text-white shadow-2xl mb-6">
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
            ...
            <div class="flex-1">
                <h1 class="text-3xl sm:text-4xl font-bold mb-2">{{ $user->nome }}</h1>
                <p class="text-indigo-100 text-lg mb-4">{{ $user->lavoro }}</p>

                <div class="flex flex-wrap gap-3">
                    <span class="inline-flex items-center gap-2 px-4 py-2 bg-white/20 backdrop-blur-sm rounded-xl text-sm font-medium">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span class="text-sm font-bold text-neutral-900">{{ $user->propensione_al_conflitto }}/10</span>
                        </div>
                        <div class="h-2 bg-neutral-100 rounded-full overflow-hidden">
                    ...
                    <div class="pt-4 border-t border-neutral-100">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-semibold text-neutral-900">{{ ucfirst($user->ritmo_attivita ?? 'normale') }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-neutral-200 p-6 shadow-sm">
                ...
                <div class="flex flex-wrap gap-2">
                    @foreach($user->passioni as $passione)
                        ...
                        <span class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-purple-50 text-purple-700 border border-purple-200">
                            {{ $passione }}
                        </span>
                        @endif
                    @endforeach
