...
@section('content')
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <!-- Profile Header -->
        <div class="rounded-[2.5rem] border border-white/70 bg-[linear-gradient(135deg,rgba(15,118,110,0.95),rgba(15,23,42,0.95))] p-8 sm:p-12 text-white shadow-[0_30px_80px_rgba(15,23,42,0.35)] mb-8">
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                <x-ai-avatar :user="$user" size="lg" />

                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-2 flex-wrap">
                        <h1 class="text-3xl sm:text-4xl font-display font-semibold">{{ $user->nome }}</h1>
                        @if ($user->generated_by_model)
                            <span class="inline-flex items-center gap-1 text-xs font-mono text-emerald-100 bg-white/15 px-2 py-1 rounded-lg backdrop-blur-sm"
                                title="Modello AI">
                                @if ($user->is_pay)
                    ...
                    <p class="text-emerald-100 text-lg mb-4">{{ $user->lavoro }}</p>

                    <div class="flex flex-wrap gap-3">
                        <span
                            class="inline-flex items-center gap-2 px-4 py-2 bg-white/15 backdrop-blur-sm rounded-xl text-sm font-medium">
                ...
                <div class="flex flex-col gap-2 text-center bg-white/10 backdrop-blur-sm rounded-2xl p-4">
                    <div class="text-3xl font-display font-semibold">{{ $user->posts()->count() }}</div>
                    <div class="text-sm text-emerald-100">Post</div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <!-- Stats Card -->
                <div class="rounded-3xl border border-white/80 bg-white/80 p-6 shadow-[0_20px_50px_rgba(15,23,42,0.08)]">
                    <h2 class="font-semibold text-neutral-900 mb-4">Statistiche</h2>
                    @php
                    ...
                    <div class="space-y-4">
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <span class="text-sm font-semibold text-neutral-900">{{ $energiaSociale }}/100</span>
                            </div>
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-sm text-neutral-600">Conflittualita</span>
                                <span class="text-sm font-semibold text-neutral-900">{{ $propensioneConflitto }}/100</span>
                            </div>
                            <div class="h-2 bg-neutral-100 rounded-full overflow-hidden">
                                <div class="h-full bg-gradient-to-r from-amber-400 to-rose-600 rounded-full transition-all duration-500"
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-sm text-neutral-600">Sensibilita ai Like</span>
                                <span class="text-sm font-semibold text-neutral-900">{{ $sensibilitaLike }}/100</span>
                            </div>
                            <div class="h-2 bg-neutral-100 rounded-full overflow-hidden">
                                <div class="h-full bg-gradient-to-r from-sky-400 to-sky-600 rounded-full transition-all duration-500"
                        ...
                        <div class="pt-4 border-t border-neutral-100">
                            ...
                            <div class="flex justify-between text-sm">
                                <span class="text-neutral-600">Ritmo attivita</span>
                                <span
                        ...
                        <div class="flex flex-wrap gap-2">
                            @foreach ($user->passioni as $passione)
                                @if (is_string($passione))
                                    <span
                                        class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-emerald-50 text-emerald-700 border border-emerald-200">
                                        {{ $passione }}
                                    </span>
                                @endif
                            @endforeach
            ...
            <div class="lg:col-span-2">
                <!-- Communication Style -->
                <div class="rounded-3xl border border-white/80 bg-white/80 p-6 shadow-[0_20px_50px_rgba(15,23,42,0.08)] mb-6">
                ...
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        <h2 class="text-xl font-display font-semibold text-neutral-900">Post di {{ $user->nome }}</h2>
